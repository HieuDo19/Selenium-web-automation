...
public class CartItemRowComponent extends Component {
    ...
    public double unitPrice() {
        return
                Double.parseDouble(findElement(unitPriceSel).getText().trim());
    }

    public double itemQuantity() {
        return
                Double.parseDouble(findElement(itemQuantitySel).getAttribute("value").trim());
    }

    public double subTotal() {
        return
                Double.parseDouble(findElement(subtotalSel).getText().trim());
    }
